# https://github.com/jzhang38/EasyContext/blob/main/easy_context/zigzag_ring_attn/monkey_patch.py
import transformers
...
def apply_zigzag_ring_attn_patch_llama():
...
def apply_zigzag_ring_attn_patch_mistral():
